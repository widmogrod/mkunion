...
func init() {
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/example/runtime_package_tags.Completed", CompletedFromJSON, CompletedToJSON)
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/example/runtime_package_tags.Failed", FailedFromJSON, FailedToJSON)
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/example/runtime_package_tags.Pending", PendingFromJSON, PendingToJSON)
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/example/runtime_package_tags.Running", RunningFromJSON, RunningToJSON)
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/example/runtime_package_tags.TaskStatus", TaskStatusFromJSON, TaskStatusToJSON)
}
