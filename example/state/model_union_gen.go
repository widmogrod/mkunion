...
func (r *MarkOrderCompleteCMD) _marshalJSONMarkOrderCompleteCMD(x MarkOrderCompleteCMD) ([]byte, error) {
	...
	fieldWorkerID, err = r._marshalJSONWorkerID(x.WorkerID)
	if err != nil {
		return nil, fmt.Errorf("state: MarkOrderCompleteCMD._marshalJSONMarkOrderCompleteCMD: field name WorkerID; %w", err)
	}
	partial["WorkerID"] = fieldWorkerID
	result, err := json.Marshal(partial)
	if err != nil {
...
func (r *MarkOrderCompleteCMD) _marshalJSONWorkerID(x WorkerID) ([]byte, error) {
	result, err := shared.JSONMarshal[WorkerID](x)
	if err != nil {
		return nil, fmt.Errorf("state: MarkOrderCompleteCMD._marshalJSONWorkerID:; %w", err)
	}
	return result, nil
}
...
func (r *MarkOrderCompleteCMD) _unmarshalJSONMarkOrderCompleteCMD(data []byte) (MarkOrderCompleteCMD, error) {
	...
	if fieldWorkerID, ok := partial["WorkerID"]; ok {
		result.WorkerID, err = r._unmarshalJSONWorkerID(fieldWorkerID)
		if err != nil {
			return result, fmt.Errorf("state: MarkOrderCompleteCMD._unmarshalJSONMarkOrderCompleteCMD: field WorkerID; %w", err)
		}
	}
	return result, nil
}
...
func (r *MarkOrderCompleteCMD) _unmarshalJSONWorkerID(data []byte) (WorkerID, error) {
	result, err := shared.JSONUnmarshal[WorkerID](data)
	if err != nil {
		return result, fmt.Errorf("state: MarkOrderCompleteCMD._unmarshalJSONWorkerID: native ref unwrap; %w", err)
	}
	return result, nil
}
