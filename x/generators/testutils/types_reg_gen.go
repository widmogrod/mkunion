...
func init() {
	...
	shared.TypeRegistryStore[ListOf2[ListOf[any], *ListOf2[int64, *time.Duration]]]("github.com/widmogrod/mkunion/x/generators/testutils.ListOf2[github.com/widmogrod/mkunion/x/generators/testutils.ListOf[any],*github.com/widmogrod/mkunion/x/generators/testutils.ListOf2[int64,*time.Duration]]")
	shared.TypeRegistryStore[ListOf2[Tree, ListOf[string]]]("github.com/widmogrod/mkunion/x/generators/testutils.ListOf2[github.com/widmogrod/mkunion/x/generators/testutils.Tree,github.com/widmogrod/mkunion/x/generators/testutils.ListOf[string]]")
	...
	shared.TypeRegistryStore[ListOf[ListOf[string]]]("github.com/widmogrod/mkunion/x/generators/testutils.ListOf[github.com/widmogrod/mkunion/x/generators/testutils.ListOf[string]]")
	shared.TypeRegistryStore[ListOf[Tree]]("github.com/widmogrod/mkunion/x/generators/testutils.ListOf[github.com/widmogrod/mkunion/x/generators/testutils.Tree]")
	...
	shared.TypeRegistryStore[OmitFields]("github.com/widmogrod/mkunion/x/generators/testutils.OmitFields")
