...
func (g *SerdeJSONTagged) Generate() (string, error) {
	...
	result.WriteString("// Code generated by mkunion. DO NOT EDIT.\n")
	result.WriteString(fmt.Sprintf("package %s\n\n", shape.ToGoPkgName(g.shape)))

	impPart, err := g.GenerateImports(g.shape)
	if err != nil {
...
func (g *SerdeJSONTagged) GenerateImports(x shape.Shape) (string, error) {
	result := &strings.Builder{}
