...
func init() {
	...
	shared.TypeRegistryStore[Command]("github.com/widmogrod/mkunion/x/workflow.Command")
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/x/workflow.Command", CommandFromJSON, CommandToJSON)
	shared.TypeRegistryStore[CommandUnionJSON]("github.com/widmogrod/mkunion/x/workflow.CommandUnionJSON")
	shared.TypeRegistryStore[CommandVisitor]("github.com/widmogrod/mkunion/x/workflow.CommandVisitor")
	...
	shared.TypeRegistryStore[Dependency]("github.com/widmogrod/mkunion/x/workflow.Dependency")
	...
	shared.TypeRegistryStore[Expr]("github.com/widmogrod/mkunion/x/workflow.Expr")
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/x/workflow.Expr", ExprFromJSON, ExprToJSON)
	shared.TypeRegistryStore[ExprUnionJSON]("github.com/widmogrod/mkunion/x/workflow.ExprUnionJSON")
	shared.TypeRegistryStore[ExprVisitor]("github.com/widmogrod/mkunion/x/workflow.ExprVisitor")
	...
	shared.TypeRegistryStore[Function]("github.com/widmogrod/mkunion/x/workflow.Function")
	...
	shared.TypeRegistryStore[Predicate]("github.com/widmogrod/mkunion/x/workflow.Predicate")
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/x/workflow.Predicate", PredicateFromJSON, PredicateToJSON)
	shared.TypeRegistryStore[PredicateUnionJSON]("github.com/widmogrod/mkunion/x/workflow.PredicateUnionJSON")
	shared.TypeRegistryStore[PredicateVisitor]("github.com/widmogrod/mkunion/x/workflow.PredicateVisitor")
	shared.TypeRegistryStore[Reshaper]("github.com/widmogrod/mkunion/x/workflow.Reshaper")
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/x/workflow.Reshaper", ReshaperFromJSON, ReshaperToJSON)
	shared.TypeRegistryStore[ReshaperUnionJSON]("github.com/widmogrod/mkunion/x/workflow.ReshaperUnionJSON")
	shared.TypeRegistryStore[ReshaperVisitor]("github.com/widmogrod/mkunion/x/workflow.ReshaperVisitor")
	...
	shared.TypeRegistryStore[RunID]("github.com/widmogrod/mkunion/x/workflow.RunID")
	shared.TypeRegistryStore[RunOption]("github.com/widmogrod/mkunion/x/workflow.RunOption")
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/x/workflow.RunOption", RunOptionFromJSON, RunOptionToJSON)
	shared.TypeRegistryStore[RunOptionUnionJSON]("github.com/widmogrod/mkunion/x/workflow.RunOptionUnionJSON")
	shared.TypeRegistryStore[RunOptionVisitor]("github.com/widmogrod/mkunion/x/workflow.RunOptionVisitor")
	...
	shared.TypeRegistryStore[State]("github.com/widmogrod/mkunion/x/workflow.State")
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/x/workflow.State", StateFromJSON, StateToJSON)
	shared.TypeRegistryStore[StateUnionJSON]("github.com/widmogrod/mkunion/x/workflow.StateUnionJSON")
	shared.TypeRegistryStore[StateVisitor]("github.com/widmogrod/mkunion/x/workflow.StateVisitor")
	shared.TypeRegistryStore[StepID]("github.com/widmogrod/mkunion/x/workflow.StepID")
	...
	shared.TypeRegistryStore[Workflow]("github.com/widmogrod/mkunion/x/workflow.Workflow")
