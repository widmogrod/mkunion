...
func init() {
	...
	shared.TypeRegistryStore[Either[*Record[int], *Record[float64]]]("github.com/widmogrod/mkunion/x/projection.Either[*github.com/widmogrod/mkunion/x/projection.Record[int],*github.com/widmogrod/mkunion/x/projection.Record[float64]]")
	shared.JSONMarshallerRegister("github.com/widmogrod/mkunion/x/projection.Either[*github.com/widmogrod/mkunion/x/projection.Record[int],*github.com/widmogrod/mkunion/x/projection.Record[float64]]", EitherFromJSON[*Record[int], *Record[float64]], EitherToJSON[*Record[int], *Record[float64]])
	...
	shared.TypeRegistryStore[Left[*Record[int], *Record[float64]]]("github.com/widmogrod/mkunion/x/projection.Left[*github.com/widmogrod/mkunion/x/projection.Record[int],*github.com/widmogrod/mkunion/x/projection.Record[float64]]")
	...
	shared.TypeRegistryStore[Record[Either[int, float64]]]("github.com/widmogrod/mkunion/x/projection.Record[github.com/widmogrod/mkunion/x/projection.Either[int,float64]]")
	...
	shared.TypeRegistryStore[RecoveryOptions[SnapshotState]]("github.com/widmogrod/mkunion/x/projection.RecoveryOptions[github.com/widmogrod/mkunion/x/projection.SnapshotState]")
	shared.TypeRegistryStore[Right[*Record[int], *Record[float64]]]("github.com/widmogrod/mkunion/x/projection.Right[*github.com/widmogrod/mkunion/x/projection.Record[int],*github.com/widmogrod/mkunion/x/projection.Record[float64]]")
	...
	shared.TypeRegistryStore[Watermark[Either[int, float64]]]("github.com/widmogrod/mkunion/x/projection.Watermark[github.com/widmogrod/mkunion/x/projection.Either[int,float64]]")
